...
export const ALERT_MESSAGE_TEST_SETS_START =
  "Failed to retrieve test sets for ";

export const ALERT_MESSAGE_TEST_SETS_END =
  "Production tests not currently available for ";

export const LOG_LOCATION = "Synaptics/_links/Production_Tests_Log";

export const DEFAULT_TEST_SET_ID = "all";

export const DEFAULT_TEST_SET_NAME = "All";
